...
if __name__ == '__main__':
    ...
    # Parameters 
    args.add_argument('--version', type=str, default='POC')                     # train, valid, POC
    ...
    args.add_argument("--del_silence", type=bool, default=False)
    args.add_argument("--remove_noise", type=bool, default=False)
